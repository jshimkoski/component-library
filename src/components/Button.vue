<template>
  <Component
    ...
    class="
      inline-flex items-center gap-2 cursor-pointer px-4 py-2 
      text-white bg-blue-500 rounded hover:bg-blue-600 
      disabled:opacity-50 disabled:pointer-events-none [&[data-disabled]]:opacity-50 [&[data-disabled]]:pointer-events-none
      [&[data-active='true']]:bg-blue-700 active:bg-blue-700
    "
