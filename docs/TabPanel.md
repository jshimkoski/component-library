...
### TabPanel with Badges

<div class="bg-base-50 dark:bg-base-900 p-6 rounded-lg mb-4">
  <Tabs>
    <TabPanel label="Messages" badge="5" badge-kind="primary">
      <div class="p-4">
        <h3 class="text-lg font-semibold mb-2">Inbox</h3>
        <p>You have 5 unread messages.</p>
      </div>
    </TabPanel>
    <TabPanel label="Notifications" badge="New" badge-kind="success">
      <div class="p-4">
        <h3 class="text-lg font-semibold mb-2">Notifications</h3>
        <p>Latest updates and notifications.</p>
      </div>
    </TabPanel>
    <TabPanel label="Warnings" badge="!" badge-kind="warning">
      <div class="p-4">
        <h3 class="text-lg font-semibold mb-2">System Warnings</h3>
        <p>Important system alerts and warnings.</p>
      </div>
    </TabPanel>
  </Tabs>
</div>
...
<div class="bg-base-50 dark:bg-base-900 p-6 rounded-lg mb-4">
  <Tabs>
    <TabPanel label="Form" icon="material-symbols:edit">
      <div class="p-4 space-y-4">
        ...
        />
        <Action kind="primary">Save Changes</Action>
      </div>
    </TabPanel>
    
    <TabPanel label="Data" icon="material-symbols:table-view">
      <div class="p-4">
        <Table 
          :fields="[
            { key: 'name', label: 'Name' },
    ...
    <TabPanel label="Chart" icon="material-symbols:bar-chart">
      <div class="p-4">
        ...
        <div class="space-y-3">
          <div>
            ...
            <Progress :model-value="75" kind="success" />
          </div>
          ...
          <div>
            ...
            <Progress :model-value="60" kind="info" />
          </div>
          ...
          <div>
            ...
            <Progress :model-value="23" kind="warning" />
          </div>
        </div>
      </div>
    </TabPanel>
...
<Tabs>
  ...
  <TabPanel label="Data" icon="material-symbols:table-view">
    <div class="p-4">
      <Table :fields="tableFields" :items="tableData" />
    </div>
  </TabPanel>
